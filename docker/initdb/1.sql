...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='登录日志存储表';
...
CREATE TABLE `questionnaire_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='调查问卷模板类型表';
...
CREATE TABLE `template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='调查问卷模板表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='调查问卷模板问题表，用于存储模板中的问题';
...
CREATE TABLE `template_question_option` (
  ...
  PRIMARY KEY (`id`),
  KEY `question_id` (`question_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='调查问卷模板问题选项存储表';
